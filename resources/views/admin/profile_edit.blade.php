...
<div class="container">
    ...
    <div class="bg-secondary">
        ...
        <div class="ml-5 mr-4 row">
            <form class="offset-md-2" action="{{ action('Admin\UserController@update') }}" method="post" enctype="multipart/form-data">
                <div class="form-group mt-3">
                    <div class="firstItem">
                    <label class="control-label">名前</label>
                    <br><input class="form-control" type="text" value="{{ $user_form->name }}" disabled>
                    </div>
                    <div class="secondItem mt-3">
                    <label class="control-label">メールアドレス</label>
                    <br><input class="form-control" type="text" value="{{ $user_form->email }}" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <div class="firstItem">
                    <label class="control-label" for="nickname">ニックネーム</label>
                    <input class="form-control" type="text" name="nickname" value="{{ $user_form->nickname }}">
                    </div>
                </div>
                <div class="form-group">
                    <div class="secondItem mr-4">
                        ...
                        <div class="radio mt-2" name="gender" value="{{ Auth::user()->gender }}">
                            <label><input class="mr-2 ml-2" type="radio" name="gender" value="男性" {{ ($user_form->gender=="男性")? "checked" : "" }}>男性</label>
                            <label><input class="mr-2 ml-2" type="radio" name="gender" value="女性" {{ ($user_form->gender=="女性")? "checked" : "" }}>女性</label>
                            <label><input class="mr-2 ml-2" type="radio" name="gender" value="その他" {{ ($user_form->gender=="その他")? "checked" : "" }}>その他</label>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select id="birth_year" class="form-control" name="birth_year">
                                        ...
                                        @for ($i = 1980; $i <= 2005; $i++)
                                            ...
                                            <option value="{{ $i }}" {{ ($user_form->birth_year == $i)? "selected" : "" }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                ...
                                <div class="col-md-3">
                                    <select id="birth_month" class="form-control" name="birth_month">
                                        <option value="">--</option>
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}" {{ ($user_form->birth_month == $i)? "selected" : "" }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                ...
                                <div class="col-md-3">
                                    <select id="birth_day" class="form-control" name="birth_day">
                                        <option value="">--</option>
                                        @for ($i = 1; $i <= 31; $i++)
                                            <option value="{{ $i }}" {{ ($user_form->birth_day == $i)? "selected" : "" }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                    ...
                    <div class="firstItem">
                        ...
                        <input class="form-control col-md-6" name="age" type="text" value="{{ $user_form->age }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group mt-1">
                    ...
                    <input class="form-control" type="text" name="occupation" value="{{ $user_form->occupation }}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label" for="country">国籍</label>
                    <select class="form-control" name="country">
                        <option value="{{$user_form->country}}" selected>{{$user_form->country}}</option>
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="checkbox">
                        <label><input class="mr-2 ml-2" type="radio" name="mail_magazine" value="受け取る" {{ ($user_form->mail_magazine=="受け取る")? "checked" : "" }}>受け取る</label>
                        <label><input class="mr-2 ml-2" type="radio" name="mail_magazine" value="受け取らない" {{ ($user_form->mail_magazine=="受け取らない")? "checked" : "" }}>受け取らない</label>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-10">
