            ...
            <form class="offset-md-2" action="{{ action('Auth\ProfileController@update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="secondItem mr-4">
                        ...
                        <div class="radio mt-2" name="gender">
                            <label><input class="mr-2 ml-2" type="radio" name="gender" value="男性">男性</label>
                    ...
                    <div class="firstItem">
                        ...
                        <input class="form-control col-md-6" name="age" type="text">
                    </div>
                  </div>
                ...
                <div class="form-group @if(!empty($errors->first('country'))) has-error @endif">
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="checkbox">
                        <label><input class="mr-2 ml-2" type="radio" name="mail_magazine" value="受け取る" checked>受け取る</label>
                ...
                <div class="form-group row">
                    <div class="col-md-10">
                        ...
                        <input type="hidden" name="login_counter" value="0">
                        {{ csrf_field() }}
