...
<div class="container">
    ...
    <h1>お問い合わせフォーム</h1>
        <div class="row">
            ...
            <form action="{{ action('Front\ContactController@create') }}" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                　<label class="col-md-1 offset-md-1" for="name">単語</label>
                　<div class="col-md-4">
                ...
                <div class="form-group row">
                　<label class="col-md-1 offset-md-1" for="phonetic_symbol">発音</label>
                　<div class="col-md-4">
                ...
                <div class="form-group row">
                    <label class="col-md-1 offset-md-1" for="meaning">意味</label>
                    <div class="col-md-9">
                ...
                {{ csrf_field() }}
                <input type="submit" class="btn btn-primary col-md-3 offset-md-2" value="登録">
            </form>
        </div>
    </div>
</div>
