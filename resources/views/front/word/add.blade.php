    ...
    <div class="row">
        <div class="col-md-8 offset-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    　  <input type="text" id="search_field" class="form-control" name="phonetic_symbol" value="{{ old('phonetic_symbol') }}" placeholder="仮想キーボード">
                    　</div>
            ...
            <div class="form-group row">
                ...
                <div class="meaning">
                　  <input type="text" id="meaning" class="form-control" name="meaning" value="{{ old('meaning') }}" required>
            　　</div>　
            </div>
                {{--  <div class="form-group row">
                    <label class="col-md-1" for="meaning">意味</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input type="file" id="sound_path" accept="audio/*" class="form-control-file" name="sound">
        ...
        <div class="key_modal__content">
            <div id="keyboard">
                <ul class="jkeyboard">
                    <li class="jline">
                        <ul>
                            <li class="jkey chinese_keyboard">&nbsp;</li>
